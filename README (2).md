...
![Coefficient Importance](media/image1.png){width="5.833333333333333in" height="3.888888888888889in"}  
![Precision--Recall Curve](media/image2.png){width="5.833333333333333in" height="3.888888888888889in"}
...
This revised README highlights the personal motivation behind the project, justifies data choices, summarises methods and findings, and explicitly weaves visuals into the narrative---addressing many of the concerns raised by Onur Varol.

[\[1\]](https://github.com/berksankir/DSA-project/blob/main/README.md#L47-L64) README.md

<https://github.com/berksankir/DSA-project/blob/main/README.md>
